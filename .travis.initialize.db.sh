...
if [ ! -z "${DB}" ]; then
    ...
    mysql -h 127.0.0.1 -P 3306 -u root -e 'drop user travis@localhost; drop user root@localhost; drop user travis; create user super@localhost; grant all on *.* to super@localhost with grant option'
    mysql -h 127.0.0.1 -P 3306 -u super -e 'drop user root'
